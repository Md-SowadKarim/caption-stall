...
function Contact() {
    ...
    return (
        <div className="bg-gradient-to-b from-blue-300 to-red-300 h-96 w-full">
            
            <div className="w-full flex items-center justify-center my-12">
                <div className="absolute top-40 bg-gray-400 shadow rounded py-12 lg:px-28 px-8">
                    ...
                    <div className="flex items-center justify-center w-full">
                        <button className="mt-9 text-base font-semibold leading-none text-white py-4 px-10 bg-red-400 rounded hover:bg-purple-700 focus:ring-2 focus:ring-offset-2 focus:ring-red-300 focus:outline-none">SUBMIT</button>
                    </div>
                </div>
            </div>
        </div>
